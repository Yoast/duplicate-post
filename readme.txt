...
* Deprecates the `dp_duplicate_post` and `dp_duplicate_page` hooks.
...
* Introduces a new unified `duplicate_post_after_duplicated` action hook that replaces them. The new hook includes the post type as a fourth parameter for flexible filtering.
