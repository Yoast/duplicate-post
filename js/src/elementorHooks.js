...
function dpelementorinitialize() {
    /**
     ...
     */
    class DuplicatePostElementorUIHook extends $e.modules.hookUI.Base {
        /**
     ...
     */
    class DuplicatePostElementorDataHook extends $e.modules.hookData.Base {
        /**
         * Constructs this class.
         *
         * @param {string}   hook     The hook to register to.
     ...
     * @returns {void}
     */
     function duplicatePostRegisterElementorUIHookAfter( hook, id, callback ) {
        $e.hooks.registerUIAfter( new DuplicatePostElementorUIHook( hook, id, callback ) );
    }
     ...
     * @returns {void}
     */
     function duplicatePostRegisterElementorDataHookAfter( hook, id, callback ) {
        $e.hooks.registerDataAfter( new DuplicatePostElementorDataHook( hook, id, callback ) );
    }

    duplicatePostRegisterElementorDataHookAfter( "document/save/save", "duplicate-post-save", () => {
        console.log ("pippo");
    } );
}
